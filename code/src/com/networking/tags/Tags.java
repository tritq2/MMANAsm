...
public class Tags {
	...
	public static String CHECKSUM_OPEN_TAG = "<CHECKSUM>";
	public static String CHECKSUM_CLOSE_TAG = "/CHECKSUM";
	...
	private static int equalData(String msg) {
		if (msg.equals(""))
			return IN_VALID;
		if (msg.equals(SIGN_UP_OPEN_TAG))
			return 1;
		if (msg.equals(SIGN_UP_END_TAG))
			return 2;
		if (msg.equals(USER_NAME_OPEN_TAG))
			return 3;
		if (msg.equals(USER_NAME_END_TAG))
			return 4;
		if (msg.equals(PASSWORD_OPEN_TAG))
			return 5;
		if (msg.equals(PASSWORD_END_TAG))
			return 6;
		if (msg.equals(SIGN_UP_SUCCESS_OPEN_TAG))
			return 7;
		if (msg.equals(SIGN_UP_UNSUCCESS))
			return 8;
		if (msg.equals(LOG_IN_OPEN_TAG))
			return 9;
		if (msg.equals(LOG_IN_END_TAG))
			return 10;
		if (msg.equals(LOG_IN_RES_SUCCESS_OPEN_TAG))
			return 11;
		if (msg.equals(LOG_IN_RES_FAIL))
			return 12;
		if (msg.equals(IP_OPEN_TAG))
			return 13;
		if (msg.equals(IP_END_TAG))
			return 14;
		if (msg.equals(LOG_OUT_OPEN_TAG))
			return 15;
		if (msg.equals(LOG_OUT_END_TAG))
			return 16;
		if (msg.equals(PEER_NAME_OPEN_TAG))
			return 17;
		if (msg.equals(PEER_NAME_END_TAG))
			return 18;
		if (msg.equals(IS_ONLINE_OPEN_TAG))
			return 19;
		if (msg.equals(IS_ONLINE_END_TAG))
			return 20;
		if (msg.equals(TO_PEER_OPEN_TAG))
			return 21;
		if (msg.equals(TO_PEER_END_TAG))
			return 22;
		if (msg.equals(TO_IP_OPEN_TAG))
			return 23;
		if (msg.equals(TO_IP_END_TAG))
			return 24;
		if (msg.equals(LIST_ONL_PEER_OPEN_TAG))
			return 25;
		if (msg.equals(LIST_ONL_PEER_END_TAG))
			return 26;
		if (msg.equals(CHAT_REQ_OPEN_TAG))
			return 27;
		if (msg.equals(CHAT_REQ_END_TAG))
			return 28;
		if (msg.equals(MY_NAME_OPEN_TAG))
			return 29;
		if (msg.equals(MY_NAME_END_TAG))
			return 30;
		if (msg.equals(SERVER_SENT_PORT_OPEN_TAG))
			return 31;
		if (msg.equals(SERVER_SENT_PORT_END_TAG))
			return 32;
		if (msg.equals(MESSAGE_OPEN_TAG))
			return 33;
		if (msg.equals(MESSAGE_END_TAG))
			return 34;
		if (msg.equals(ESC_CHAT_OPEN_TAG))
			return 35;
		if (msg.equals(ESC_CHAT_END_TAG))
			return 36;
		if (msg.equals(PORT_OPEN_TAG))
			return 37;
		if (msg.equals(PORT_END_TAG))
			return 38;
		if (msg.equals(SHARE_FILE_OPEN_TAG))
			return 39;
		if (msg.equals(SHARE_FILE_END_TAG))
			return 40;
		if (msg.equals(LIST_FILE_OPEN_TAG))
			return 41;
		if (msg.equals(LIST_FILE_END_TAG))
			return 42;
		if (msg.equals(FILE_OPEN_TAG))
			return 43;
		if (msg.equals(FILE_END_TAG))
			return 44;
		if (msg.equals(FILE_REQ_OPEN_TAG))
			return 45;
		if (msg.equals(FILE_REQ_END_TAG))
			return 46;
		...
		if (msg.equals(SESSION_CLOSE_TAG))
			return 53;
		if (msg.equals(SESSION_KEEP_ALIVE_CLOSE_TAG))
			return 54;
		if (msg.equals(SESSION_KEEP_ALIVE_OPEN_TAG))
			return 55;
		if (msg.equals(PUBLIC_KEY_OPEN_TAG))
			return 56;
		...
		if (msg.equals(IV_CLOSE_TAG))
			return 65;
		if (msg.equals(CHECKSUM_OPEN_TAG))
			return 66;
		if (msg.equals(CHECKSUM_CLOSE_TAG))
			return 67;
